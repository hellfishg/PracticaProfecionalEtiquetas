    ...
    <table style="width: 100%">
        <tr>
            <td colspan="2">
                ...
                <asp:TextBox ID="Apellido" runat="server" MaxLength="50" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Nombre" runat="server" MaxLength="50" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Provincia" runat="server" MaxLength="30" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Localidad" runat="server" MaxLength="30" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Direccion" runat="server" MaxLength="50" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Telefono" runat="server" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                <br />
                ...
                <asp:TextBox ID="Celular" runat="server" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                <br />
                ...
                <asp:TextBox ID="Email" runat="server" MaxLength="50" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Sexo" runat="server" MaxLength="1" style="color: #FFFFFF"></asp:TextBox>
                <span style="color: #FFFFFF">
                ...
                <asp:DropDownList ID="EstadoCivil" runat="server" style="color: #FFFFFF">
                ...
                <asp:TextBox ID="Nacionalidad" runat="server" MaxLength="50" style="color: #FFFFFF"></asp:TextBox>
            </td>
        </tr>
        <tr>
